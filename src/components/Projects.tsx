      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 pt-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {projects.map((project, idx) => (
            ...
            <div
              className="group bg-white/[0.02] rounded-2xl border border-white/[0.06] overflow-hidden hover:bg-white/[0.04] hover:border-white/[0.12] transition-all duration-500 transform-gpu hover:[transform:perspective(800px)_rotateX(2deg)_rotateY(-2deg)_translateZ(10px)] hover:shadow-xl hover:shadow-purple-500/5 h-full"
            >
        ...
        <div className="mt-12 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative inline-flex items-center gap-3 px-8 py-4 bg-white text-slate-950 rounded-xl font-bold hover:bg-gray-100 transition-all hover:scale-105 transform duration-300 overflow-hidden"
          >
            ...
            <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 bg-gradient-to-r from-transparent via-purple-200/20 to-transparent"></div>
          </a>
        </div>
        </Reveal>
      </div>
