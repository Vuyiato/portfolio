        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 md:space-y-8 order-2 md:order-1">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start pt-6">
              <a
                href="#projects"
                className="group px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all font-bold text-center shadow-lg hover:shadow-purple-500/50 hover:scale-105 transform inline-flex items-center gap-2"
              >
                View My Work
          ...
          <div className="relative order-1 md:order-2 flex justify-center">
            <div className="relative w-80 h-80">
              ...
              {/* Status badge */}
              <div className="absolute bottom-6 left-6 px-4 py-2 bg-green-500/20 border border-green-400 text-green-300 rounded-full text-sm font-bold backdrop-blur-md flex items-center gap-2">
